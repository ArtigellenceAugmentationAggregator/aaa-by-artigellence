...
(function () {
  ...
  function scriptedReply(q){
    if(/(trade|plumb|electric|sparky|build|carpenter|hvac|field|servicem8|tradify)/.test(q)){
      ...
      botSay("It's per-piece and transparent. Entry is <b>Phase 0 — A$4,500, fully refundable</b>. After that, agents are A$3,000 each (min 4). Packages: <b>Pilot & Prove A$9,750</b>, Traction Lean A$13,500, Essentials Build A$16,500, Full Build A$28,500, Flagship Year-1 A$56,500 — all incl GST. Traction also runs monthly if you prefer I drive it: Presence A$750, Engine A$1,500, Growth A$3,000/mo — month-to-month, first week delivered before invoiced. Which fits depends on your biggest bottleneck. What's yours?",["How does the pilot work?","I run a trades business","Book the pilot"]);
